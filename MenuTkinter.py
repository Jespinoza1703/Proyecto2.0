...
def inicio():
	...
	def ventana_practica():
		...
		label9_Single = Label(modo_practica, text="Single", font = "Helvetica 18")
		label9_Single.place(x=280, y=100)
		label6_Single = Label(modo_practica, text="Single", font = "Helvetica 18")
		label6_Single.place(x=280, y=200)
		label3_Single = Label(modo_practica, text="Single", font = "Helvetica 18")
		label3_Single.place(x=280, y=300)	
		label9_Double = Label(modo_practica, text="Double", font = "Helvetica 18")
		label9_Double.place(x=280, y=130)
		label6_Double = Label(modo_practica, text="Double", font = "Helvetica 18")
		label6_Double.place(x=280, y=230)
		label3_Double = Label(modo_practica, text="Double", font = "Helvetica 18")
	...
	oneplayer_label = Label(ventana, text=traduccion[0][IDIOMA], font = "Helvetica 20", bg = 'black', fg = 'white')
	oneplayer_label.place(x = 355, y = 195)
	oneplayertworacket_label = Label(ventana, text=traduccion[1][IDIOMA], font = "Helvetica 20", bg = 'black', fg = 'white')
	oneplayertworacket_label.place(x = 625, y = 195)
	twoplayer_label = Label(ventana, text=traduccion[2][IDIOMA], font = "Helvetica 20", bg = 'black', fg = 'white')
	twoplayer_label.place(x = 350, y = 370)
	twoplayertworacket_label = Label(ventana, text=traduccion[3][IDIOMA], font = "Helvetica 20", bg = 'black', fg = 'white')
	twoplayertworacket_label.place(x = 625, y = 370)
	about_label = Label(ventana, text=traduccion[5][IDIOMA], font = "Helvetica 20", bg = 'black', fg = 'white')
	about_label.place(x = 110, y = 415)
	help_label = Label(ventana, text=traduccion[4][IDIOMA], font = "Helvetica 20", bg = 'black', fg = 'white')
